  ...
  return (
    <div className={`min-h-screen ${styles.background.primary}`}>
      ...
      <section className={`py-20 lg:py-32 ${styles.background.secondary}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            variants={fadeInUp}
          >
            <h2 className={`text-3xl md:text-5xl font-bold ${styles.text.primary} mb-6`}>
            ...
            {benefits.map((benefit, index) => {
              ...
              return (
                <motion.div
                  ...
                  variants={fadeInUp}
                >
                  <div className="inline-flex p-4 rounded-xl bg-gradient-to-r from-primary-500 to-accent-500 mb-4">
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            className={`text-center p-12 rounded-2xl ${styles.card.default}`}
            initial="initial"
            whileInView="animate"
            viewport={{ once: true }}
            variants={fadeInUp}
